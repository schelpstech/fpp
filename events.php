...
<html lang="en">
  <head>
    ...
    <title>Francis PlayPen Nursery & Primary School, Lagos </title>
    <meta name="description" content="Contact us at FPP Schools for admission enquiries and procedures.">
    <meta name="keywords" content="Francis PlayPen Nursery & Primary School, Lagos, Francis PlayPen Nursery & Primary School, FPP Schools, Primary Schools Lagos, Best Schools in Lagos, Egbeda Schools , Schools in Egbeda">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9 probootstrap-top-quick-contact-info">
              <span><i class="icon-location2"></i>12 Lola Ayodele Street, Seliat Estate, Egbeda, Lagos State, Nigeria</span>
              <span><i class="icon-phone2"></i>+234-8023-165-420</span>
              <span><i class="icon-mail"></i>info@fppschools.com</span>
            </div>
      ...
      <nav class="navbar navbar-default probootstrap-navbar">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html" title="FPP Schools">FPP Schools</a>
          </div>

          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="index.html">Home</a></li>
              <li><a href="courses.html">Our Classes</a></li>
              <li><a href="teachers.html">Our Teachers</a></li>
              <li class="active"><a href="events.html">Our Events</a></li>
              <li class="dropdown">
                <a href="#" data-toggle="dropdown" class="dropdown-toggle">Portals</a>
                <ul class="dropdown-menu">
                  <li><a href="about.html">Exp</a></li>
